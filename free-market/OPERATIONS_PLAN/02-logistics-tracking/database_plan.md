...
CREATE TABLE cargo_shipments (
    ...
    customer_id UUID NOT NULL,                    -- stable customer reference; ERPNext mapping belongs to OP-03
...
CREATE INDEX idx_shipments_customer ON cargo_shipments(customer_id);
