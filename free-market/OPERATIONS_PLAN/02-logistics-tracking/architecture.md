...
5. On customs release / delivery complete, the service emits an approved financial command to **OP-03** only when a charge, invoice or payable is created; ordinary tracking events remain in the logistics database.
...
|----------|-------------|
| Tracking DB → ERPNext | **Blocked** outright; only OP-03 receives approved financial commands |
