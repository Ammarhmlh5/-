...
class Config:
    ...
    DATABASE_URL = os.getenv(
        'DATABASE_URL',
        'postgresql+psycopg://market_user:marketpass2026@localhost:5543/shipping_marketplace'
    )
    ...
    OP03_GATEWAY_URL = os.getenv('OP03_GATEWAY_URL', 'http://localhost:5000')
    OP03_CALLBACK_URL = os.getenv('OP03_CALLBACK_URL', 'http://localhost:8002/api/market/webhooks/op03')
...
class TestingConfig(Config):
    ...
    DATABASE_URL = os.getenv(
        'TEST_DATABASE_URL',
        'postgresql+psycopg://market_user:marketpass2026@localhost:5543/shipping_marketplace_test'
    )
